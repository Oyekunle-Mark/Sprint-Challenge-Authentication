...
1. What is the purpose of using _sessions_?
   ...
   _Sessions allow us to keep track of users when they use our website. We create sessions to ensure clients can interact with the backend with ease._

2. What does bcrypt do to help us store passwords in a secure manner.

   _bcrypt generates a hash of plain text passwords and does so with a random salt to add another layer of security against attacks._

3. What does bcrypt do to slow down attackers?

   _It uses a salt to hash the password. This step ensures the attacker has to generate a rainbow table for each hashed password. bcrypt also hashes the password thousands of times to slow down the process._
